...
@Component({
  selector: 'app-inner-split-pane',
  standalone: true,
  imports: [CommonModule],
  templateUrl: './inner-split-pane.component.html',
  styleUrls: ['./inner-split-pane.component.scss'],
})
export class InnerSplitPaneComponent implements OnInit {
  ...
  @Input() set collapsed(value: boolean | null) {
    ...
    this.isCollapsed = value as boolean;
  }
